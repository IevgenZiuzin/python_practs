...
Необходимо создать третье множество, содержащее названия, которые есть во втором множестве,
но нет в первом.
"""
...
if __name__ == '__main__':
    ...
    print(f'Set 1: {largest_europe_cities}\n'
          ...
          f'Intersection: {get_difference(largest_world_cities, largest_europe_cities)}')
